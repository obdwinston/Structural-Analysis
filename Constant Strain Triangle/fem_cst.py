...
Np = [5420, 4344, 4343, 4345, 4373, 4372, 4365, 4367, 4358, 4356, 92, 90, 4389, 4388, 888, 4383, 4382, 4390, 5118, 5423]  # point force node [Np1, Np2, ...]
Fp = []  # point force [[Fpx, Fpy], ...]

p = 500e6  # surface force
L = 0.05/(len(Np) - 1)  # element length
Fs = p*L*t/2  # point force equivalent
