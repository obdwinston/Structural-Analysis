...
mesh = 'tapered.su2'  # mesh file

E = 200e9  # Young's modulus [Pa]
nu = .25  # Poisson's ratio
t = .005  # thickness [m]

Np = [5598, 4479, 4478, 4477, 4428, 4422, 4440, 4474, 4464, 4462, 4457, 4466, 4475, 4481, 4488, 4439, 4437, 4490, 4487, 4486, 4489, 5600]  # point force node - [Np1, Np2, ...]
Fp = []  # point force [N] - [[Fpx, Fpy], ...] 

p = 1e9  # surface force [Pa]
L = .05  # surface length [m]
